...
export default async function Login({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <main id="main" className="login"><Link className="wordmark" href="/">koodos<span>®</span></Link><h1>Welcome back.</h1><p className="muted">A home for the work we make together. Sign in with your invited email address.</p>
