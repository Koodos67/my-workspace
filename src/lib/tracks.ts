...
export const DEFAULT_TRACKS = [
  ...
  { name: 'Plan', summary: 'Sitemap, content model, design direction, stack recommendation', deliverable: 'Plan for approval', recurring: false },
  ...
  { name: 'Launch', summary: 'Migration, redirects, analytics, handover documentation', deliverable: 'Live site and keys', recurring: false },
